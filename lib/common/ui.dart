...
class Ui {
  static GetSnackBar SuccessSnackBar({String title = 'Success', String message = '', SnackPosition? snackPosition}) {
  ...
  static GetSnackBar ErrorSnackBar({String title = 'Error', String message = '', SnackPosition ? snackPosition}) {
...
/*      customRenders: {
  ...
  static String? getDistance(double distance) {
    ...
    if (_unit == 'km') {
      distance *= 1.60934;
      return distance.toStringAsFixed(2) + " " + _unit.tr;
    }
    return null;
  }
