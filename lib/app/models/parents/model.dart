...
abstract class Model {
  ...
  @override
  bool operator ==(dynamic other) => other is Model && other.id == id;
  ...
  String durationFromJson(Map<String, dynamic>? json, String attribute, {String defaultValue = '00:00', String fromFormat = 'HH:mm', String toFormat = "HH'h' mm'm'"}) {
    try {
