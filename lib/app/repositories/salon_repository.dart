...
class SalonRepository {
  ...
  Future<List<EService>> getEServices(String salonId, List<String> categories, {int page = 1}) {
  ...
  Future<List<EService>> getPopularEServices(String salonId, List<String> categories, {int page = 1}) {
    return _laravelApiClient.getSalonPopularEServices(salonId, categories, page);
  }

  Future<List<EService>> getMostRatedEServices(String salonId, List<String> categories, {int page = 1}) {
    return _laravelApiClient.getSalonMostRatedEServices(salonId, categories, page);
  }

  Future<List<EService>> getAvailableEServices(String salonId, List<String> categories, {int page = 1}) {
    return _laravelApiClient.getSalonAvailableEServices(salonId, categories, page);
  }

  Future<List<EService>> getFeaturedEServices(String salonId, List<String> categories, {int page = 1}) {
