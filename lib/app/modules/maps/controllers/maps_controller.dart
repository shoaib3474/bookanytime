 ...
 * Last modified: 2023.01.26 at 18:38:49
...
class MapsController extends GetxController {
  ...
  Future<Marker> _getMyPositionMarker(LatLng latLng) async {
    ...
    final Marker marker = Marker(
        markerId: MarkerId(Random().nextInt(100).toString()), icon: BitmapDescriptor.fromBytes(markerIcon), anchor: ui.Offset(0.5, 0.5), position: latLng);
