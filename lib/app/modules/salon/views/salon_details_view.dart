 ...
 * Last modified: 2024.04.16 at 19:38:42
      ...
      return Wrap(
        children: [
          SalonTilWidget(
            ...
            content: Ui.applyHtml(controller.salon.value.description, style: Get.textTheme.bodyLarge),
          ),
          buildContactUs(),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(controller.salon.value.address!.address ?? '', style: Get.textTheme.bodySmall),
                          ],
                        ),
                      ),
                      MaterialButton(
