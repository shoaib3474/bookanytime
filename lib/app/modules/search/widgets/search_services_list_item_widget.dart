              ...
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: [
                      Ui.getPrice(_service.getPrice, style: Get.textTheme.titleLarge),
                    ],
                  ),
                  Row(
                    children: [
                  ...
                  Wrap(
                    ...
                    children: List.generate(_service.subCategories!.length, (index) {
                      return Container(
                        ...
                        child: Text(_service.subCategories!.elementAt(index).name!, style: Get.textTheme.bodySmall?.merge(TextStyle(fontSize: 10))),
