/*
 * File name: chat_message_item_widget.dart
 * Last modified: 2023.01.26 at 18:26:50
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              DateFormat('d, MMMM y | HH:mm', Get.locale.toString()).format(DateTime.fromMillisecondsSinceEpoch(this.chat.time ?? 0)),
      ...
      child: Column(
        ...
        children: [
                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      new Text(this.chat.user?.name ?? '',
                          style: Get.textTheme.bodyMedium?.merge(TextStyle(fontWeight: FontWeight.w600, color: Get.theme.primaryColor))),
                      new Container(
                        margin: const EdgeInsets.only(top: 5.0),
                        child: new Text(
                          chat.text ?? '',
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
            child: Text(
              DateFormat('HH:mm | d, MMMM y', Get.locale.toString()).format(DateTime.fromMillisecondsSinceEpoch(this.chat.time ?? 0)),
              overflow: TextOverflow.fade,
              softWrap: false,
              style: Get.textTheme.bodySmall,
            ),
